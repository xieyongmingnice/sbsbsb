...
/**
 * @author xym
 * @description 系统白名单关键字管理控制器
 * @date 2018/5/8 15:10
 */
@RestController
@RequestMapping("/whitekeyword")
public class SysWhitelistKeywordController {
    ...
    @ResponseBody
    public Result<String> addKeyword(SysWhitelistKeywordModel model){
    ...
    @ResponseBody
    public Result<String> deleteKeyword(SysWhitelistKeywordModel model){
        Result result = checkLogin(new Result(), model.getSessionId());
        if (result.getMessage() != null) {
            return result;
        }
    ...
    @ResponseBody
    public Result<String> getKeywordList(SysWhitelistKeywordModel model){
        Result result = checkLogin(new Result(),model.getSessionId());
        if(result.getMessage() != null ){
            return result;
        }
        ...
        List<SysWhitelistKeyword> list = keywordService.selectKeywordList(model);
    ...
    @ResponseBody
    public Result<String> batchDeleteKeyword(SysWhitelistKeywordModel model){
        Result result = checkLogin(new Result(),model.getSessionId());
        if(result.getMessage() != null ){
            return result;
        }
    ...
    public Result<String> excelAddKeyword(HttpServletRequest request,String sessionId) throws Exception{
        ...
        List<SysWhitelistKeyword> list = Lists.newArrayList();
    ...
    @ResponseBody
    public Result<String> checkKeyword(SysWhitelistKeywordModel model){
        Result result = checkLogin(new Result(),model.getSessionId());
        if(result.getMessage() != null ){
            return result;
        }
